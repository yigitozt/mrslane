...
public class IAPTest : MonoBehaviour {
	...
	public string premiumProductID = "com.yigitozturk.flappynoob.unlock1";
//	public string noAdsProductID = "com.vitapoly.gamekittest.noads";
	public string coinsProductID = "com.yigitozturk.flappynoob.coins";
			...
			GUILayout.BeginArea(new Rect(50, 50, Screen.width - 100, Screen.height/2 - 50));
				...
				GUILayout.BeginHorizontal();
					...
					if (GUILayout.Button("Buy Coins", GUILayout.ExpandHeight(true))) {
						// buy 2 coins
						IAPXT.Buy(coinsProductID, 1);
					}
			
					if (GUILayout.Button("Unlockable", GUILayout.ExpandHeight(true))) {
						// buy premium upgrade
